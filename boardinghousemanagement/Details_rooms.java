 ...
 * @author User
 */
public class Details_rooms extends javax.swing.JFrame {

    /**
     * Creates new form Details_rooms
     */
    public Details_rooms() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String SUser = "root";
        String SPass = "";
        String Room = "1"; // Example: Room 1 is checked. Update this with user input.
...
private boolean checkRoomOccupied(Connection con, String Room) throws SQLException {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Details_rooms.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Details_rooms().setVisible(true);
            }
        });
    }
